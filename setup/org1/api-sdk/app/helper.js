...
const getCaUrl = async (org, ccp) => {
    let caURL;
    if (org == "Org1") {
        caURL = ccp.certificateAuthorities['ca.org1.midominio.com'].url;

    } else if (org == "Org2") {
        caURL = ccp.certificateAuthorities['ca.org2.midominio.com'].url;
    } else
        return null
    return caURL
...
const getCaInfo = async (org, ccp) => {
    let caInfo
    if (org == "Org1") {
        caInfo = ccp.certificateAuthorities['ca.org1.midominio.com'];

    } else if (org == "Org2") {
        caInfo = ccp.certificateAuthorities['ca.org2.midominio.com'];
    } else
        return null
    return caInfo
...
const enrollAdmin = async (org, ccp) => {
    ...
    try {
        ...
        const caInfo = await getCaInfo(org, ccp) //ccp.certificateAuthorities['ca.org1.midominio.com'];
